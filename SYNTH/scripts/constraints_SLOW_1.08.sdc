...
set_input_delay   0.5  -clock CLK  [get_ports sh* -filter {@port_direction == in}]
set_output_delay  0.5  -clock CLK  [get_ports sh* -filter {@port_direction == out}]

set_input_delay   0.5  -clock CLK  [get_ports pri* -filter {@port_direction == in}]
set_output_delay  0.5  -clock CLK  [get_ports pri* -filter {@port_direction == out}]

set_input_delay   0.5  -clock CLK  [get_ports axi* -filter {@port_direction == in}]
set_output_delay  0.5  -clock CLK  [get_ports axi* -filter {@port_direction == out}]
